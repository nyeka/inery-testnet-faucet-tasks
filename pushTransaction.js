...
const account = "ikalnazim";
const actor = "ikalnazim";
...
const ReadTransaction = async (id) => {
  try {
    ...
    console.log(readId);
    console.log("Record read by ikalnazim\n\n");
  } catch (error) {
    console.log(error);
  }
};
...
const DestroyTrancsaction = async (id) => {
  try {
    ...
    console.log("Record destroyed by ikalnazim\n\n");
...
PushTransaction(1050, account, "test push transaction by ikalnazim");
